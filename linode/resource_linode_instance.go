...
func resourceLinodeInstanceUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	/////////////
	// If future disk size is bigger & the instance is resizing, we run the instance resize first.
	// If future disk size is smaller & the instance is resizing, we run the instance resize after.
